        ...
        {loading ? (
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              {/* Bid Input Section */}
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
                <div className="p-6 bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 dark:from-blue-900/30 dark:to-purple-900/30">
                  {isAuctionActive ? (
                    <div className="space-y-4">
                      <div className="relative">
                        ...
                        <input
                          type="number"
                          className="block w-full pl-10 pr-4 py-4 text-lg rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition-all duration-200 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                      ...
                      <button
                        onClick={handleBid}
                        className="w-full py-4 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white text-lg font-semibold rounded-xl transition-all duration-300 transform hover:scale-[1.02] focus:ring-4 focus:ring-blue-500/20 flex items-center justify-center gap-2"
                      >
